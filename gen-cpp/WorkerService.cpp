        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->shard_paths.resize(_size110);
            uint32_t _i114;
            for (_i114 = 0; _i114 < _size110; ++_i114)
            {
              xfer += iprot->readString(this->shard_paths[_i114]);
            }
...
uint32_t WorkerService_reassign_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("shard_paths", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter115 = this->shard_paths.begin(); _iter115 != this->shard_paths.end(); ++_iter115)
    {
...
uint32_t WorkerService_reassign_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("shard_paths", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter116 = (*(this->shard_paths)).begin(); _iter116 != (*(this->shard_paths)).end(); ++_iter116)
    {
